...
def main():
    ...
    if ("juliegil" in os.getcwd()):
        ...
        s_path = "/Users/chbl/Dropbox (University of Michigan)/MED-LauringLab/SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/"
        full_loc = "/Users/chbl/Dropbox (University of Michigan)/MED-LauringLab/SEQUENCING/INFLUENZA_A/4_SequenceSampleMetadata/FinalSummary/full_compiled_data.csv"    
    else:

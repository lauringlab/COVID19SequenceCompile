...
def main():
    ...
    files_avail[['subject_id', 'typeAorB', 'segment', 'segment2']] = files_avail['segment_info'].str.split('_', expand=True)

    files_avail['count'] = files_avail.groupby('subject_id')['subject_id'].transform('count')
    ...
    meta_file = s_path + args.prefix + "/" + args.prefix + ".roche.forgenbank.meta.csv" # This is made in genbank file prep code - just uploaded names + sample ifs
    ...
    to_keep = files_avail.merge(meta, how='inner', on='subject_id')
    ...
    file_3 = s_path + args.prefix + "/" + args.prefix + ".all.consensus.roche.final.genbank.fasta"
    #print(file_2)

################################################################################
#          Check of Cumulative Dataset for Influenza Genetic Sampling          #
#                           Created: 11/19/2021                                #
...
compiled_loc <- paste0(starting_path, "SEQUENCING/INFLUENZA_B/4_SequenceSampleMetadata/FinalSummary")

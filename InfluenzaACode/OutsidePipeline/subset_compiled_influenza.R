...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20220620_IAV_Illumina_Run_25/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "25" & PlateDate == "2022-06-20")
...
write.csv(seq_list2, paste0(outputLOC, "20220620_IAV_Illumina_Run_25.meta.csv"), row.names = FALSE, na = "")

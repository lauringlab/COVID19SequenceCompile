...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20220117_IAV_Nanopore_Run_11/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "11" & PlateDate == "2022-01-17")
...
write.csv(seq_list2, paste0(outputLOC, "20220117_IAV_Nanopore_Run_11.meta.csv"), row.names = FALSE, na = "")

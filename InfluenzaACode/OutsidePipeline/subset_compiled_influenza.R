...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20211118_IAV_Nanopore_Run_6/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "6" & PlateDate == "2021-11-18")
...
write.csv(seq_list2, paste0(outputLOC, "20211118_IAV_Nanopore_Run_6.meta.csv"), row.names = FALSE, na = "")

...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20220725_IAV_Illumina_Run_26/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "26" & PlateDate == "2022-07-25")
...
write.csv(seq_list2, paste0(outputLOC, "20220725_IAV_Illumina_Run_26.meta.csv"), row.names = FALSE, na = "")

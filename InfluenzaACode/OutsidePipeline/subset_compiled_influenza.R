...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20220523_IAV_Illumina_Run_21/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "21" & PlateDate == "2022-05-23")
...
write.csv(seq_list2, paste0(outputLOC, "20220523_IAV_Illumina_Run_21.meta.csv"), row.names = FALSE, na = "")

...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20211110_Nanopore_Run_73/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "73" & PlateDate == "2021-11-10")
...
write.csv(seq_list2, paste0(outputLOC, "20211110_Nanopore_Run_73.meta.csv"), row.names = FALSE, na = "")

...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20211112_IAV_Nanopore_Run_4/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "4" & PlateDate == "2021-11-12")
...
write.csv(seq_list2, paste0(outputLOC, "20211112_IAV_Nanopore_Run_4.meta.csv"), row.names = FALSE, na = "")

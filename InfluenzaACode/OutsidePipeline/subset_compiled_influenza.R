...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20220104_IAV_Nanopore_Run_9/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "9" & PlateDate == "2022-01-04")
...
write.csv(seq_list2, paste0(outputLOC, "20220104_IAV_Nanopore_Run_9.meta.csv"), row.names = FALSE, na = "")

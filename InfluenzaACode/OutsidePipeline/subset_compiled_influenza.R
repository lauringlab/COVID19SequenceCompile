...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20220314_IAV_Nanopore_Run_14/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "14" & PlateDate == "2022-03-14")
...
write.csv(seq_list2, paste0(outputLOC, "20220314_IAV_Nanopore_Run_14.meta.csv"), row.names = FALSE, na = "")

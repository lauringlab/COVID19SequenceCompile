...
outputLOC <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/3_ProcessedGenomes/20220303_IAV_Nanopore_Run_13/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "13" & PlateDate == "2022-03-03")
...
write.csv(seq_list2, paste0(outputLOC, "20220303_IAV_Nanopore_Run_13.meta.csv"), row.names = FALSE, na = "")

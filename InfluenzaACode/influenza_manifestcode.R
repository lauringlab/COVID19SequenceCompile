################################################################################
#       Creation of Manifest Dataset for Influenza A & B Genetic Sampling      #
#                          Updated: 7/20/2023                                  #
...
roche_manifest_fp <- paste0(starting_path, "SEQUENCING/INFLUENZA_A/4_SequenceSampleMetadata/Manifests/ROCHE")
...
roche_manifestb_fp <- paste0(starting_path, "SEQUENCING/INFLUENZA_B/4_SequenceSampleMetadata/Manifests/ROCHE")
...
manifest_folder_list <- c(cbr_manifest_fp, uhs_manifest_fp, stj_manifest_fp, mm_manifest_fp, 
                          ...
                          rvtn_manifest_fp, hfhs_manifest_fp, asj_manifest_fp, mdhhs_manifest_fp, roche_manifest_fp)

manifest_b_folder_list <- c(asj_manifestb_fp, cbr_manifestb_fp, cdcivy_manifestb_fp, 
                            hfhs_manifestb_fp, rvtn_manifestb_fp, martin_manifestb_fp, mdhhs_manifestb_fp, roche_manifestb_fp)
...
outputLOCb <- paste0(starting_path, "SEQUENCING/INFLUENZA_B/4_SequenceSampleMetadata/Manifests/ManifestsComplete")
...
for (each_list in i_folderlists){
      ...
      write.csv(flu_a, paste0(outputLOC, "/sample_full_manifest_list.csv"), row.names = FALSE, na = "")
      write.csv(flu_b, paste0(outputLOCb, "/sample_full_manifest_list.csv"), row.names = FALSE, na = "")

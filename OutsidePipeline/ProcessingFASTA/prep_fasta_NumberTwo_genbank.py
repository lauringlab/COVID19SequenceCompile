...
def main():
    ...
    if ("juliegil" in os.getcwd()):
        ...
        s_path = "/Users/chbl/University of Michigan Dropbox/MED-LauringLab/SEQUENCING/SARSCOV2/3_ProcessedGenomes/"
        full_loc = "/Users/chbl/University of Michigan Dropbox/MED-LauringLab/SEQUENCING/SARSCOV2/4_SequenceSampleMetadata/FinalSummary/full_compiled_data.csv"    
    else:

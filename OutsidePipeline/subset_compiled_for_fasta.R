...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20211202_SC2_Nanopore_Run_82/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "82" & PlateDate == "2021-12-02")
...
write.csv(seq_list2, paste0(outputLOC, "20211202_SC2_Nanopore_Run_82.meta.csv"), row.names = FALSE, na = "")

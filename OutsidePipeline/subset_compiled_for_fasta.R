...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20220111_SC2_Nanopore_Run_99/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "99" & PlateDate == "2022-01-11")
...
write.csv(seq_list2, paste0(outputLOC, "20220111_SC2_Nanopore_Run_99.meta.csv"), row.names = FALSE, na = "")

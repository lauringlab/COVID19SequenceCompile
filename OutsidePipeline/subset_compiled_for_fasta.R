...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20210907_Nanopore_Run_47/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "47" & PlateDate == "2021-09-07")
...
write.csv(seq_list2, paste0(outputLOC, "20210907_Nanopore_Run_47.meta.csv"), row.names = FALSE, na = "")

...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20211209_SC2_Nanopore_Run_85/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "85" & PlateDate == "2021-12-09")
...
write.csv(seq_list2, paste0(outputLOC, "20211209_SC2_Nanopore_Run_85.meta.csv"), row.names = FALSE, na = "")

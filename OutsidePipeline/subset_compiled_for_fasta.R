...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20211129_SC2_Nanopore_Run_79/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "79" & PlateDate == "2021-11-29")
...
write.csv(seq_list2, paste0(outputLOC, "20211129_SC2_Nanopore_Run_79.meta.csv"), row.names = FALSE, na = "")

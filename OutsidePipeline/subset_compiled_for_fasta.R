...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20211215_SC2_Nanopore_Run_89/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "89" & PlateDate == "2021-12-15")
...
write.csv(seq_list2, paste0(outputLOC, "20211215_SC2_Nanopore_Run_89.meta.csv"), row.names = FALSE, na = "")

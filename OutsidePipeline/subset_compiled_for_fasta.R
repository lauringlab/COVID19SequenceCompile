...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20211122_SC2_Nanopore_Run_77/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "77" & PlateDate == "2021-11-22")
...
write.csv(seq_list2, paste0(outputLOC, "20211122_SC2_Nanopore_Run_77.meta.csv"), row.names = FALSE, na = "")

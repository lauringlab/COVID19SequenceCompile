...
outputLOC <- paste0(starting_path, "SEQUENCING/SARSCOV2/3_ProcessedGenomes/20211115_SC2_Nanopore_Run_74/")
...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "74" & PlateDate == "2021-11-15")
...
write.csv(seq_list2, paste0(outputLOC, "20211115_SC2_Nanopore_Run_74.meta.csv"), row.names = FALSE, na = "")

...
################################################################################
# filter to plate run
seq_list2 <- filter(seq_list, PlateNumber == "42" & PlateDate == "2021-08-24")
...
write.csv(seq_list2, paste0(outputLOC, "20210824_Nanopore_Run_42.meta.csv"), row.names = FALSE, na = "")

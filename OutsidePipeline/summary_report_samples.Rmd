...
ggplot(pangolin_calls, aes(x = coll_date, y = ind_count, fill = voi_voc_pangolin)) + 
  ...
  scale_fill_manual(values = c("dodgerblue", "dodgerblue", "coral2", "darkcyan", "darkcyan", 
                               ...
                               "lightskyblue", "plum4", "paleturquoise", "dodgerblue", "dodgerblue", "coral2", "darkcyan", "darkcyan", 
                               "darkcyan", "deepskyblue", "deepskyblue4", "darkolivegreen2", 
                               "darkolivegreen3", "forestgreen", "forestgreen", "darkorchid", 
                               "gray75", "mediumpurple1", "mediumpurple1", "mediumpurple1", 
...
ggplot(nextclade_calls, aes(x = coll_date, y = ind_count, fill = voi_voc_nextclade)) + 
  ...
  theme_bw() + 
  #theme(legend.position = "none") +
  scale_fill_manual(values = c("dodgerblue", "mediumpurple", "goldenrod", "orange3", "violetred", "tomato3", "skyblue1", "slateblue1", "palegreen3", "darkorchid4", "lightblue1", "gray75", "olivedrab3", "lightgoldenrod1", "lightpink", "paleturquoise")) + 

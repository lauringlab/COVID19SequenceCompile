...
#                 Code Edited By: Julie (Jules) Gilbert and Leigh Papalambros  #
#
################################################################################
...
dir.create(paste0(starting_path, "/SEQUENCING/RSV_A/6_GenBank_Uploads/upload_", plate_datef, "_", tolower(runtech), "_run_", runnum))

...
def main():
    ...
    if ("juliegil" in os.getcwd()):
        ...
        s_path = "/Users/leighbak/University of Michigan Dropbox/MED-LauringLab/SEQUENCING/RSV_B/3_ProcessedGenomes/"
    ...
    for record in SeqIO.parse(file_1, "fasta"):
        ...
        if(id in IDs):
            ...
            record.id = ""
            record.description = str(new_ID) + " [BioProject=PRJNA1079770]" # needed to change numeric sample_ids to be recognized as character strings

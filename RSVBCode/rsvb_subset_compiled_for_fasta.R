...
if (missing_subject_id > (nrow(seq_list2) - num_rsvs_on_plate)){
  print("Check manifests for:")
  print(plate_name)
  stop("Subject IDs Missing")
}

if (missing_collection_date > (nrow(seq_list2) - num_rsvs_on_plate)){
  print("Check manifests for:")
  print(plate_name)
  stop("Collection Dates Missing")
}

if (missing_received_source > (nrow(seq_list2) - num_rsvs_on_plate)){
  print("Check manifests for:")
  print(plate_name)
  stop("Received Sources Missing")
}

if (nrow(seq_list2) != num_rsvs_on_plate + missing_subject_id){

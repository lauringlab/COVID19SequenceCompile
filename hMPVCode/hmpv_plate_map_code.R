...
# plate map file path
platemap_fp <- paste0(starting_path, "SEQUENCING/hMPV/4_SequenceSampleMetadata/PlateMaps")

### output location of plate map files, all together
outputLOC <- paste0(starting_path, "SEQUENCING/hMPV/4_SequenceSampleMetadata/PlateMaps/PlateMapsComplete")
